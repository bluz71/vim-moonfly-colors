...
let s:inactive1 = [s:white[0],   s:grey236[0], s:white[1],   s:grey236[1]]
let s:inactive2 = [s:white[0],   s:grey236[0], s:white[1],   s:grey236[1]]
let s:inactive3 = [s:white[0],   s:grey236[0], s:white[1],   s:grey236[1]]
