...
let s:normal2      = [s:white[0],   s:grey16[0],  s:white[1],   s:grey16[1]]
let s:normal3      = [s:white[0],   s:grey16[0],  s:white[1],   s:grey16[1]]
let s:inactive1    = [s:grey62[0],  s:grey16[0],  s:grey62[1],  s:grey16[1]]
let s:inactive2    = [s:grey62[0],  s:grey16[0],  s:grey62[1],  s:grey16[1]]
let s:inactive3    = [s:grey62[0],  s:grey16[0],  s:grey62[1],  s:grey16[1]]
let s:insert1      = [s:grey11[0],  s:emerald[0], s:grey11[1],  s:emerald[1]]
let s:insert2      = [s:white[0],   s:grey16[0],  s:white[1],   s:grey16[1]]
let s:insert3      = [s:white[0],   s:grey16[0],  s:white[1],   s:grey16[1]]
let s:visual1      = [s:grey11[0],  s:purple[0],  s:grey11[1],  s:purple[1]]
let s:visual2      = [s:white[0],   s:grey16[0],  s:white[1],   s:grey16[1]]
let s:visual3      = [s:white[0],   s:grey16[0],  s:white[1],   s:grey16[1]]
let s:commandline1 = [s:grey11[0],  s:yellow[0],  s:grey11[1],  s:yellow[1]]
let s:commandline2 = [s:white[0],   s:grey16[0],  s:white[1],   s:grey16[1]]
let s:commandline3 = [s:white[0],   s:grey16[0],  s:white[1],   s:grey16[1]]
let s:replace1     = [s:grey11[0],  s:crimson[0], s:grey11[1],  s:crimson[1]]
let s:replace2     = [s:white[0],   s:grey16[0],  s:white[1],   s:grey16[1]]
let s:replace3     = [s:white[0],   s:grey16[0],  s:white[1],   s:grey16[1]]
let s:warning      = [s:yellow[0],  s:grey16[0],  s:yellow[1],  s:grey16[1]]
let s:error        = [s:crimson[0], s:grey16[0],  s:crimson[1], s:grey16[1]]
