...
if exists('g:lightline')
    ...
    let s:p.normal.warning  = [ [ s:khaki, s:grey236 ] ]
    ...
    let s:p.insert.left     = [ [ s:grey236, s:white ], [ s:white, s:grey236 ] ]
    let s:p.replace.left    = [ [ s:grey236, s:crimson ], [ s:white, s:grey236 ] ]
    let s:p.visual.left     = [ [ s:grey236, s:purple ], [ s:white, s:grey236 ] ]
