...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#323437', '#ff5454', '#8cc85f', '#e3c78a', '#80a0ff', '#cf87e8', '#79dac8', '#c6c6c6', '#949494', '#ff5189', '#36c692', '#c2c292', '#74b2ff', '#ae81ff', '#85dc85', '#e4e4e4']"
        dset background-color "'#080808'"
        dset foreground-color "'#bdbdbd'"
...
gset string palette "#323437:#ff5454:#8cc85f:#e3c78a:#80a0ff:#cf87e8:#79dac8:#c6c6c6:#949494:#ff5189:#36c692:#c2c292:#74b2ff:#ae81ff:#85dc85:#e4e4e4"

gset string background_color "#080808"
gset string foreground_color "#bdbdbd"
