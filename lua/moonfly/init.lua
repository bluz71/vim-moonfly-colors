...
M.plugins = function()
  ...
  -- nvim-navic plugin
  highlight(0, "NavicText", { bg = bg, fg = grey249 })
  highlight(0, "NavicSeparator", { bg = bg, fg = white })
  highlight(0, "NavicIconsOperator", { bg = bg, fg = cranberry })
  ...
  highlight(0, "NavicIconsConstructor", { bg = bg, fg = sky })
  ...
  highlight(0, "NavicIconsString", { bg = bg, fg = khaki })
