...
M.style = function()
  ...
  highlight(0, "MoonflyDiagnosticUndercurlOk", { undercurl = true, sp = emerald })
  ...
  highlight(0, "MoonflyDiagnosticUnderlineOk", { underline = true, sp = emerald })
  ...
  highlight(0, "MoonflyDiagnosticVirtualTextOk", { bg = grey234, fg = emerald })
  ...
  if g.moonflyUndercurls then
    ...
    highlight(0, "DiagnosticUnderlineOk", { link = "MoonflyDiagnosticUndercurlOk" })
  else
    ...
    highlight(0, "DiagnosticUnderlineOk", { link = "MoonflyDiagnosticUnderlineOk" })
  end
  if g.moonflyVirtualTextColor then
    ...
    highlight(0, "DiagnosticVirtualTextOk", { link = "MoonflyDiagnosticVirtualTextOk" })
  else
