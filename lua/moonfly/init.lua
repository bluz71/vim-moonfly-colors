...
M.core = function()
  ...
  if fn.has("nvim-0.8") then
    ...
    highlight(0, "TSAnnotation", { link = "MoonflyViolet" })
    highlight(0, "TSAttribute", { link = "MoonflySky" })
    highlight(0, "TSConstant", { link = "MoonflyTurquoise" })
    highlight(0, "TSConstBuiltin", { link = "MoonflyGreen" })
    highlight(0, "Macro", { link = "MoonflyGreen" })
    highlight(0, "TSConstructor", { link = "MoonflyEmerald" })
    highlight(0, "TSDanger", { link = "Todo" })
    highlight(0, "TSFuncBuiltin", { link = "MoonflySky" })
    highlight(0, "TSFuncMacro", { link = "MoonflySky" })
    highlight(0, "TSInclude", { link = "MoonflyCranberry" })
    highlight(0, "TSKeywordOperator", { link = "MoonflyViolet" })
    highlight(0, "TSNamespace", { link = "MoonflyTurquoise" })
    highlight(0, "TSParameter", { link = "MoonflyWhite" })
    highlight(0, "TSPunctSpecial", { link = "MoonflyCranberry" })
    highlight(0, "TSSymbol", { link = "MoonflyPurple" })
    highlight(0, "TSTag", { link = "MoonflyBlue" })
    highlight(0, "TSTagDelimiter", { link = "MoonflyLime" })
    highlight(0, "TSVariableBuiltin", { link = "MoonflyLime" })
    -- Language specific overrides.
    highlight(0, "bashTSParameter", { link = "MoonflyTurquoise" })
    highlight(0, "cssTSPunctDelimiter", { link = "MoonflyCranberry" })
    highlight(0, "cssTSType", { link = "MoonflyBlue" })
    highlight(0, "scssTSPunctDelimiter", { link = "MoonflyCranberry" })
    highlight(0, "scssTSType", { link = "MoonflyBlue" })
    highlight(0, "scssTSVariable", { link = "MoonflyTurquoise" })
    highlight(0, "vimTSVariable", { link = "MoonflyTurquoise" })
    highlight(0, "vimTSVariableBuiltin", { link = "MoonflyEmerald" })
    highlight(0, "yamlTSField", { link = "MoonflySky" })
    highlight(0, "yamlTSPunctDelimiter", { link = "MoonflyCranberry" })
  end
