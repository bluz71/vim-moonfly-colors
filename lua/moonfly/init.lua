...
M.style = function()
  ...
  highlight(0, "DapUIPlayPause", { link = "MoonflyGreen" })
  highlight(0, "DapUIRestart", { link = "MoonflyGreen" })
  highlight(0, "DapUIScope", { link = "MoonflySky" })
  highlight(0, "DapUISource", { link = "MoonflyViolet" })
  highlight(0, "DapUIStepBack", { link = "MoonflyTurquoise" })
  highlight(0, "DapUIStepInto", { link = "MoonflyTurquoise" })
  highlight(0, "DapUIStepOut", { link = "MoonflyTurquoise" })
  highlight(0, "DapUIStepOver", { link = "MoonflyTurquoise" })
  highlight(0, "DapUIStop", { link = "MoonflyRed" })
  ...
  highlight(0, "DapUIUnavailable", { link = "MoonflyGrey241" })
