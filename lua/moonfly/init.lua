...
M.core = function()
  ...
  highlight(0, "@text.reference", { link = "MoonflyTurquoise" })
  highlight(0, "@text.strike", { strikethrough = true })
  highlight(0, "@text.strong", { link = "MoonflyYellow" })
...
M.plugins = function()
  ...
  highlight(0, "GitSignsChange", { link = "MoonflyBlueAlert" })
  highlight(0, "GitSignsChangeDelete", { link = "MoonflyCoralAlert" })
  highlight(0, "GitSignsChangeLn", { link = "MoonflyBlue" })
  highlight(0, "GitSignsChangeNr", { link = "MoonflyBlueAlert" })
